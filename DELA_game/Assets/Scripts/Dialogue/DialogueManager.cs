...
public class DialogueManager : MonoBehaviour
{
    ...
    private IEnumerator EndDialogueCoroutine()
    {
        ...
        // Set the state of the NPC to that of finished dialogue
        ...
        {
            case "Matige Meren":
                scoreManager.SetInteracted("NPCLake");
                break;
            case "Diepe Doelen":
                scoreManager.SetInteracted("NPCFootball");
                break;
            case "Woeste Wateren":
                scoreManager.SetInteracted("NPCWaterTower");
                break;
            case "Boze Bergen":
                scoreManager.SetInteracted("NPCMines");
                break;
            case "Wazige Woud":
                scoreManager.SetInteracted("NPCForrestHut");
                break;
        }
    }
